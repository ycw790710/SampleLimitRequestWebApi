...
{
    /// <summary>
    /// RequestRateLimitStatusPerTimeUnitInfo
    /// </summary>
    [DataContract(Name = "RequestRateLimitStatusPerTimeUnitInfo")]
    public partial class RequestRateLimitStatusPerTimeUnitInfo : IEquatable<RequestRateLimitStatusPerTimeUnitInfo>, IValidatableObject
    {
        ...
        {
            return this.Equals(input as RequestRateLimitStatusPerTimeUnitInfo);
        }

        /// <summary>
        /// Returns true if RequestRateLimitStatusPerTimeUnitInfo instances are equal
        /// </summary>
        /// <param name="input">Instance of RequestRateLimitStatusPerTimeUnitInfo to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RequestRateLimitStatusPerTimeUnitInfo input)
        {
            if (input == null)
            {
                return false;
